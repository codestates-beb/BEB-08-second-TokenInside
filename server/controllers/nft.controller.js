...
const erc721Contract = new web3.eth.Contract(erc721abi,'0xE961F7B10f6ab0A78beaE6eF1cC272625BfD8a84');
...
exports.minting_post = async (req, res, next) => {
  try {
    ...
    if(setToken_In){
      const tokenNumber = await erc721Contract.methods.mintNFT(sub1_addr,tokenurl,'hi2','예외적으로')
      ...
      if(tokenNumber){
        ...
        const token_amount = await erc20Contract.methods.balanceOf(userInfoBySession.address).call();
